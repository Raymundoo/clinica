...
SECRET_KEY = '7&i3qk)x85#+26%y2jkbjjen1@o^0#ao=tt3q@cjm7-j=lyeo&'

# SECURITY WARNING: don't run with debug turned on in production!
#Brazzers Angela White Kagney Linn Karter Phoenix Marie Dinner For Cheats Girl Seduced Video
DEBUG = True
ALLOWED_HOSTS = ['*']
